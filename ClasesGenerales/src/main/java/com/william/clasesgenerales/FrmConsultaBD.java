...
public class FrmConsultaBD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbMat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(cbMat, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int idEstudiante =Valuemeber[cbEstu.getSelectedIndex()];
        int idMateria = ValuememberM[cbMat.getSelectedIndex()];
        Nota nt = new Nota();
        Notas nts = new Notas();
        nt.setNota(txtNota.getText());
        nt.setIdEstudiante(idEstudiante);
        nt.setIdMateria(idMateria);
        nts.AgregarNotas(nt);
        cargar();
//        JOptionPane.showMessageDialog(null, idMateria);
    ...
    public void cargar() {
        String titulos[] = {"NOMBRE", "NOTA", "NOMBRE MATERIA"};
...
//            
    ...
    int ValuememberM[];
    public void EjercicioValuemember(){
            MateriaDAO md = new MateriaDAO();
            ArrayList<Materia> materia = md.ListadoMaterias();
            ...
            String filas[] = new String[2];
             ...
             ValuememberM= new int[materia.size()];
            ...
            while (iterator.hasNext()) {
                ...
                ValuememberM[intContador] = MateriaCls.getIdmateria();
                 
                DefaultComboBoxModel.addElement(MateriaCls.getNombreMateria());
                intContador++;
           
            }
            cbMat.setModel(DefaultComboBoxModel);
    }
    /**
